...
const CATEGORIES = [
  {
    icon: "Star",
    title: "Новичок",
    desc: "Первый шаг в мире автозвука. Стандартные системы с ограничениями по мощности и оборудованию.",
    level: "Старт",
  },
  {
    icon: "StarHalf",
    title: "Новичок без ограничений",
    desc: "Класс для начинающих без жёстких ограничений по комплектующим. Свобода выбора оборудования.",
    level: "Старт+",
  },
  {
    icon: "Music2",
    title: "Любитель",
    desc: "Уверенный уровень инсталляции. Продуманная система с хорошим балансом звука.",
    level: "Любитель",
  },
  {
    icon: "Music",
    title: "Любитель без ограничений",
    desc: "Любительский класс с расширенными возможностями. Больше свободы в выборе компонентов.",
    level: "Любитель+",
  },
  {
    icon: "TrendingUp",
    title: "Прогресс",
    desc: "Переходный класс для тех, кто готов к серьёзным соревнованиям. Высокий уровень подготовки.",
    level: "Прогресс",
  },
  {
    icon: "Trophy",
  ...
  {
    icon: "Crown",
    title: "Эксперт без ограничений",
    desc: "Абсолютная свобода в построении системы. Максимальный уровень мастерства и техники.",
    level: "Профи+",
  },
  {
    icon: "Headphones",
    title: "Sound Only",
    desc: "Только качество звучания. Оценивается исключительно музыкальность, сцена и детальность.",
    level: "SQ",
  },
];
...
const RESULTS = [
  { place: "1", name: "Алексей Громов", city: "Москва", category: "Эксперт", score: "1-е место" },
  { place: "2", name: "Дмитрий Волков", city: "СПб", category: "Прогресс", score: "2-е место" },
  { place: "3", name: "Сергей Басов", city: "Екб", category: "Любитель", score: "3-е место" },
  { place: "4", name: "Иван Ударников", city: "НСК", category: "Sound Only", score: "4-е место" },
];
...
const JUDGES = [
  ...
  { name: "Олег Кириллов", role: "Судья Sound Only", exp: "10 лет, эксперт Hi-Fi", city: "Краснодар" },
  { name: "Виталий Громов", role: "Судья Эксперт", exp: "9 лет в соревнованиях RSQ", city: "Екатеринбург" },
];
...
const SPONSORS = [
  ...
  { name: "DD Audio", type: "Официальный партнёр" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { num: "03", icon: "Gauge", title: "Замер / Прослушка", desc: "Все классы оцениваются по качеству звучания: прослушивание экспертной комиссией RSQ." },
